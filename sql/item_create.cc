...
class Create_func_xxh32 : public Create_native_func
{
public:
  Item *create_native(THD *thd, const LEX_CSTRING *name,
                      List<Item> *item_list) override;
...
class Create_func_xxh3 : public Create_native_func
{
public:
  Item *create_native(THD *thd, const LEX_CSTRING *name,
                      List<Item> *item_list) override;
...
Item *Create_func_xxh32::create_native(THD *thd, const LEX_CSTRING *name,
                                       List<Item> *item_list)
{
  int argc= item_list ? item_list->elements : 0;
  if (unlikely(argc != 1))
...
Item *Create_func_xxh3::create_native(THD *thd, const LEX_CSTRING *name,
                                      List<Item> *item_list)
{
  int argc= item_list ? item_list->elements : 0;
  if (unlikely(argc != 1))
